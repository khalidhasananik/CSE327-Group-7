...
if (isset($_POST['add-member-btn'])) {
    ...
    if ($memberPassword === $memberConfirmPassword) {
        ...
        if (!$is_member) {
            ...
            $insert = "INSERT INTO `members`(`mname`, `email`, `phone`, `joindate`, `pid`, `discount`, `password`) VALUES ('$memberName', '$memberEmail', '$memberPhone', '$memberJoinDate', '$memberPlan',  '$memberPassword')";
