                ...
                <form method="post" action="query.php" class="add-btn d-flex justify-content-end mb-3">
                    <div class="">
                        <input type="text" class="form-control" id="search" name="search"
                            placeholder="Name, Email, Phone Or Service Name"
                            value="<?php echo htmlspecialchars($_GET["search"]);?>">
                    </div>
                    <button type="submit" id="member-search-btn" name="member-search-btn"
                    ...
                    <table class="table table-striped text-center no-margin-bottom">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Service (Parlor/Salon)</th>
                                <th scope="col">Number of Seats (Cafe)</th>
                        ...
                        <tbody>
                            ...
                            <tr class="middle-td">
                                ...
                                <td><?= $row['Email']; ?></td>
                                <td><?= $row['Phone']; ?></td>
                                <td><?= date('Y-m-d', strtotime($row['Reservation_Date'])); ?></td>
                                <td><?= $row['Site']; ?></td>
