      ...
      <div class="main">
        ...
        <div class="signup">
          <form action="" method="post">
            <label style="border-bottom: 3px solid red" for="chk" aria-hidden="true">MEMBER DETAILS</label>
          </form>
        ...
        <div class="login">
          <form action="frontend_auth.php" method="post">
            <label style="margin-bottom: 0" for="chk" aria-hidden="true">Edit</label>
            ...
            <input type="email" name="email" placeholder="Email" required value="<?php echo $_SESSION['memberEmail']; ?>" />
